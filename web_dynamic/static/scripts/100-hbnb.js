$(document).ready(()=>{
    ...
    $(document).on('change', ".amenities > .popover > li > input[type='checkbox']", ()=>{
        if (this.checked) {
    ...
    $(document).on('change', ".locations > .popover > li > input[type='checkbox']", ()=>{
        if (this.checked) {
    ...
    $(document).on('change', ".locations > .popover > li > ul > li > input[type='checkbox']", ()=>{
        if (this.checked) {
